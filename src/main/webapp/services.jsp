...
<p>RR offers Corporate and Retail Internet Banking Products and Other Value Added Services</p>
<p>Select a link in the list to view details of a specific product.</p>

   <font face="Times New Roman" size="+1" color="black">
  <ol type="disc">
	 <li><a href="etax.jsp">RR E-Tax</a></li> <br>
	<li><a href="billpay.jsp">Bill Payment</a></li><br>
	<li><a href="dd.jsp">Demand Draft</a></li><br>
	<li><a href="cbr.jsp">Cheque Book Request</a></li><br>
	<li><a href="te.jsp">Transaction Enquiry</a></li><br>
	<li><a href="aor.jsp">Account Opening Request</a></li><br>
