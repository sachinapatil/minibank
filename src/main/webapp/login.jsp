            ...
            <table border="1" width="30%" cellpadding="5">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" name="fname" value="" class="form-control marTop10 marBot10 boxsgn" placeholder="Your username"/></td>
                    </tr>
                    <tr>

                        <td><input type="text" name="mob-no" value="" class="form-control marTop10 marBot10 boxsgn" placeholder="Mobile Number"/></td>
                    </tr>
                    <tr>
          
                        <td><input type="text" name="ac-no" value="" class="form-control marTop10 marBot10 boxsgn" placeholder="Account Number"/></td>
                    </tr>
 					<tr>
                    ...
                    <tr>
                        <td colspan="2">Already registered!! <a href="display-data.jsp">Here-Check the Status</a></td>
                    </tr>
