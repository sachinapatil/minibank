...
Thanks for send the request, you will get the Online Banking Vouchers in two working days</font>
 <center>
            <table border="1" width="30%" cellpadding="5">
             <tbody>
         <tr>
                        <td colspan="2"><a href="display-data.jsp">Here-Check the Status</a></td>
                    </tr>
